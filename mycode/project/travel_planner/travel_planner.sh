#!/bin/bash
# GRPO Training Script for travel_planner
...
export RESULT_DIR=${RESULT_DIR:-/home/ranhengwang/ndsl-project/RL-Factory/mycode/project/travel_planner/output}

python3 -m verl.trainer.main_ppo --config-name=rl_factory_ppo_trainer \
    algorithm.adv_estimator=grpo\
    data.train_files=/home/ranhengwang/ndsl-project/RL-Factory/mycode/project/travel_planner/data/travel_planner_train.parquet\
    data.val_files=/home/ranhengwang/ndsl-project/RL-Factory/mycode/project/travel_planner/data/travel_planner_train.parquet\
    ...
    actor_rollout_ref.env.name=travel_planner\
    actor_rollout_ref.env.mcp_mode=stdio\
    actor_rollout_ref.env.tool_manager=qwen3\
    actor_rollout_ref.env.enable_thinking=False\
    actor_rollout_ref.env.config_path=/home/ranhengwang/ndsl-project/RL-Factory/mycode/project/travel_planner/envs/configs/travel_planner.pydata\
    ...
    trainer.project_name='GRPO_travel_planner'\
    trainer.experiment_name='travel_planner_with_thinking'\
